...
//
//@Service
//public class GetResponseImpl2 implements GetResponse {
//
...
//
//	private final static Logger logger = Logger.getLogger(GetResponseImpl2.class);
//
...
//			BCPosting p= new BCPosting("xxx", "xxx", 62, 758756, "xxx");
//
